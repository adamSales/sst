...
par(mfrow=c(1,2))
plot(c(0,bws),c(NA,psT),main='Total Testing',xlab='$bw$',ylab='p-value',ylim=c(0,1))
...
plot(c(0,bws),c(NA,psE),main='Edge Testing',xlab='$bw$',ylab='p-value',ylim=c(0,1))
abline(v=multLine(c(0,bws)[windowsE+1],amount=0.002),col=cols[1:length(windowsE)])
legend('topright',legend=names(windowsE),col=cols[1:length(windowsE)],lty=1)
@
...
par(mfrow=c(1,2))
plot(c(0,bws),c(NA,psT1),main='Total Testing: High School GPA',xlab='$bw$',ylab='p-value',ylim=c(0,1))
...
plot(c(0,bws),c(NA,psE1),main='Edge Testing: High School GPA',xlab='$bw$',ylab='p-value',ylim=c(0,1))
abline(v=multLine(c(0,bws)[windowsE1+1],amount=0.002),col=cols[1:length(windowsE1)])
legend('topright',legend=names(windowsE1),col=cols[1:length(windowsE1)],lty=1)
...
% For $\dalphaU$ was moderate for total testing,
...
legend('topleft',legend=names(dhatsTS),
       col=cols,lty=1)
@
