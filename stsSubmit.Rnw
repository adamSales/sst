...
\runtitle{Sequential Specification Tests}

\author{\fnms{Adam C} \snm{Sales}\corref{}\ead[label=e1]{asales@utexas.edu}\thanksref{t1}}
\runauthor{Sales}

\thankstext{t1}{Thanks George Michailidis, Ben B Hansen and Brian Junker for helpful comments. This work was partially supported by IES Grant R305B1000012} 
