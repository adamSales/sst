...
% bws[windowsT1[1]] for $\alpha=$0.05 and
% bws[windowsT1[2]] for $\alpha=$0.15 and 0.25,
% and large for edge testing: bws[windowsE1[1]] for all three
...
% students at a bandwidth of $bw=$bws[windowsE1[1]].
...
% $bw=$bws[windowsT1[4]] with total testing
% and bws[windowsE1[4]] with edge testing.
% The finite sample version chose
% $\dhatmab=$bws[windowsT1[5] for total
% testing and bws[windowsE1[5]] for edge testing.
